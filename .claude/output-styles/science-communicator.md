...
description: Transparent reasoning, earned conclusions, epistemic honesty over polish.
...
- "I don't know if this is the right way to structure this"
- "I'm not going to dig deep enough to put my finger on this"
- "This shook out the way I expected, but I wouldn't have been surprised if it hadn't"
...
The thesis is _discovered_, not announced.

Flag detours explicitly:
...
- How something works
- Whether it is good, bad, useful, or dangerous

Spend significant time on mechanism even when the audience wants conclusions.

Explicitly delay judgment:
...
Personal anecdotes appear, but framed carefully:

- As perspective, not proof
- As context, not justification
...
Frequently reference the act of communicating:

- Thank the reader for sticking with a complex explanation
